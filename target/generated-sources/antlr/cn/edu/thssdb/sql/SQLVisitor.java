...
public interface SQLVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link SQLParser#setTransactionLevelStmt}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSetTransactionLevelStmt(SQLParser.SetTransactionLevelStmtContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link SQLParser#showAllTableStmt}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitShowAllTableStmt(SQLParser.ShowAllTableStmtContext ctx);
	/**
